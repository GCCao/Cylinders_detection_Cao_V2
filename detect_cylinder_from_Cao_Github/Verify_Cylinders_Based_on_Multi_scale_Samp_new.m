function [VerifiedCylinders_Multi_scale_Samp,VerifiedCylinders_pointCloud_Multi_scale_Samp] =  Verify_Cylinders_Based_on_Multi_scale_Samp_new(detectedCylinders_MulitiSampling,detectedCylinders_pointCloud_MulitiSampling,angleThreshold,distanceThreshold)
...
VerifiedCylinders_pointCloud_Multi_scale_Samp = {};
...
detectedCylinders_pointCloud_Samp1 = detectedCylinders_pointCloud_MulitiSampling{1};

Indexs1 = zeros(size(detectedCylinders_Samp1,2),1);
Indexs2 = zeros(size(detectedCylinders_Samp1,2),1);
...
k=1;
for i=1:size(detectedCylinders_Samp1,2)
    if  Indexs1(i)>0 &&  Indexs2(i)>0
        Ci = detectedCylinders_Samp1{i};
        pointCloudi = detectedCylinders_pointCloud_Samp1{i};
        VerifiedCylinders_Multi_scale_Samp{k} = Ci;
        VerifiedCylinders_pointCloud_Multi_scale_Samp{k} = pointCloudi;
        k=k+1;
    end
end
