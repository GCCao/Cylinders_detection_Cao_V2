...
function Index_bestCylinderInliers_inValidClusterPoints = Find_points_Xsigma_frome_cylindersurface(sigma,magnification_sigma,bestCylinderModel,ValidClusterPoints)
%找到距离圆柱体表面3倍sigma的点
...
Index_bestCylinderInliers_inValidClusterPoints = find( abs(sqrt(D)- model(7))< magnification_sigma*sigma ) ; %关联点在remainingPointCloud的索引
end
