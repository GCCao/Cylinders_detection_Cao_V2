function Draw_arrows_VerifiedCylinders_Multi_scale_Samp(bestCylinderModel,number,figureNum)
...
zoomfactor= 2*bestCylinderModel.Radius;
...
text(centerstartP(1)+orthogonalLline_direction(1)*zoomfactor, centerstartP(2)+orthogonalLline_direction(2)*zoomfactor, centerstartP(3)+orthogonalLline_direction(3)*zoomfactor, num2str(number), 'FontSize', 30, 'Color', 'red');
end